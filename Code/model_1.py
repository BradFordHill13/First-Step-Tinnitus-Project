...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 14 15:47:50 2020
...
def assign_tinnitus_phenotype(row, severity_level):
    ...
    #if mean_selected_values == 1: return np.nan # if 'yes, not now, in the past' return NaN
...
def main():
    ...
    severity_level = "any"
    ###########################################################################
    output_file = "./output/phenofile_tinnitus_"+severity_level+".csv"
